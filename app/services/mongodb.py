...
class MongoDBService:
    ...
    async def get_latest_analysis(self, owner: str, repo: str, branch: str) -> Optional[Dict[str, Any]]:
    ...
    async def list_analyses(self, skip: int = 0, limit: int = 10) -> List[Dict[str, Any]]:
