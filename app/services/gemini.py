...
class GeminiService:
    ...
    async def generate_text(self, prompt: str, content: Optional[str] = None) -> GeminiResponse:
    ...
    async def analyze_code(self, code_content: str, file_path: str) -> GeminiCodeReview:
        ...
        prompt = (
            ...
            "Identify syntax errors, code quality issues, security vulnerabilities, and logic flaws. "
            "Provide severity levels, descriptions, and suggestions. "
            "Finally, evaluate the code structure and provide an overall score from 1 (poor) to 10 (excellent)."
        )
        ...
        try:
            ...
            logger.error(f"Error performing code review with Gemini: {str(e)}")
            raise e
